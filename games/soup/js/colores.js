...
(function (e, t) {
    ...
    function j(e, t, n, r) {
        var i;
        if (st.isArray(t)) st.each(t, function (t, i) {n || kn.test(e) ? r(e, i) : j(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)}); else if (n || "object" !== st.type(t)) r(e, t); else for (i in t) {
            j(e + "[" + i + "]", t[i], n, r)
        }
    }
    ...
    function B(e, t) {st.each(t, function (t, n) {
    ...
    function P(e, t, n) {
        var r, i, o = 0, a = nr.length, s = st.Deferred().always(function () {delete u.elem}), u = function () {
            ...
            elem:    e, props: st.extend({}, t), opts: st.extend(!0, {specialEasing: {}}, n), originalProperties: t, originalOptions: n, startTime: Qn || O(), duration: n.duration, tweens: [], createTween: function (t, n) {
    ...
    st.fn = st.prototype = {
        ...
        }, map:      function (e) {return this.pushStack(st.map(this, function (t, n) {return e.call(t, n, t)}))}, end: function () {return this.prevObject || this.constructor(null)}, push: tt, sort: [].sort, splice: [].splice
        ...
        noConflict:       function (t) {return e.$ === st && (e.$ = G), t && e.jQuery === st && (e.jQuery = J), st}, isReady: !1, readyWait: 1, holdReady: function (e) {e ? st.readyWait++ : st.ready(!0)}, ready: function (e) {
            ...
            if (r) {if (s)for (; a > o && (i = t.apply(e[o], r), i !== !1); o++) {
                ;
            } else for (o in e) {
            ...
            } else if (i !== t && (o = !0, st.isFunction(i) || (s = !0), c && (s ? (n.call(e, i), n = null) : (c = n, n = function (e, t, n) {return c.call(st(e), n)})), n))for (; l > u; u++) {
    ...
    st.Callbacks = function (e) {
        ...
        var n, i, o, a, s, u, l = [], c = !e.once && [], f = function (t) {
            ...
            add:            function () {
                ...
                return this
            }, remove:      function () {return l && st.each(arguments, function (e, t) {for (var n; (n = st.inArray(t, l, n)) > -1;) {
                l.splice(n, 1), o && (s >= n && s--, u >= n && u--)
            }
            }), this}, has: function (e) {return st.inArray(e, l) > -1}, empty: function () {return l = [], this}, disable: function () {return l = c = n = t, this}, disabled: function () {return !l}, lock: function () {return c = t, n || p.disable(), this}, locked: function () {return !c}, fireWith: function (e, t) {return t = t || [], t = [e, t.slice ? t.slice() : t], !l || i && !c || (o ? c.push(t) : f(t)), this}, fire: function () {return p.fireWith(this, arguments), this}, fired: function () {return !!i}
        };
        return p
    }, st.extend({
        Deferred: function (e) {
            var t = [["resolve", "done", st.Callbacks("once memory"), "resolved"], ["reject", "fail", st.Callbacks("once memory"), "rejected"], ["notify", "progress", st.Callbacks("memory")]], n = "pending", r = {
                ...
                }, promise: function (e) {return null != e ? st.extend(e, r) : r}
            }, i  = {};
    ...
    st.extend({
        ...
        }, removeData: function (e) {return this.each(function () {st.removeData(this, e)})}
    }), st.extend({
    ...
    st.fn.extend({
        ...
        }, set: function (e, t, n) {return t === !1 ? st.removeAttr(e, n) : Mt && Ht || !Lt.test(n) ? e.setAttribute(!Ht && st.propFix[n] || n, n) : e[st.camelCase("default-" + n)] = e[n] = !0, n}
    ...
    }), st.each(["href", "src"], function (e, t) {st.propHooks[t] = {get: function (e) {return e.getAttribute(t, 4)}}})), st.support.style || (st.attrHooks.style = {get: function (e) {return e.style.cssText || t}, set: function (e, t) {return e.style.cssText = t + ""}}), st.support.optSelected || (st.propHooks.selected = st.extend(st.propHooks.selected, {
        get: function (e) {
            var t = e.parentNode;
    ...
    st.event = {
        ...
        }, st.Event = function (e, n) {return this instanceof st.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? u : l) : this.type = e, n && st.extend(this, n), this.timeStamp = e && e.timeStamp || st.now(), this[st.expando] = !0, t) : new st.Event(e, n)}, st.Event.prototype = {
        ...
        }, postDispatch: function (e) {e._submit_bubble && (delete e._submit_bubble, this.parentNode && !e.isTrigger && st.event.simulate("submit", this.parentNode, e, !0))}, teardown: function () {return st.nodeName(this, "form") ? !1 : (st.event.remove(this, "._submit"), t)}
        ...
        }, teardown: function () {return st.event.remove(this, "._change"), !qt.test(this.nodeName)}
        ...
        E = a.isXML = function (e) {
            ...
            cacheLength: 50, createPseudo: i, match: pt, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {
                ATTR: function (e) {return e[1] = e[1].replace(xt, Tt), e[3] = (e[4] || e[5] || "").replace(xt, Tt), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)}, CHILD: function (e) {return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || a.error(e[0]), e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && a.error(e[0]), e}, PSEUDO: function (e) {
                    var t, n = !e[5] && e[2];
                    return pt.CHILD.test(e[0]) ? null : (e[4] ? e[2] = e[4] : n && ct.test(n) && (t = f(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            }, filter:   {
                TAG:       function (e) {return "*" === e ? function () {return !0} : (e = e.replace(xt, Tt).toLowerCase(), function (t) {return t.nodeName && t.nodeName.toLowerCase() === e})}, CLASS: function (e) {
                    var t = z[e + " "];
    ...
    st.fn.extend({
        ...
        filter:     function (e, t, n) {return n && (e = ":not(" + e + ")"), 1 === t.length ? st.find.matchesSelector(t[0], e) ? [t[0]] : [] : st.find.matches(e, t)}, dir: function (e, n, r) {
    ...
    on.optgroup = on.option, on.tbody = on.tfoot = on.colgroup = on.caption = on.thead, on.th = on.td, st.fn.extend({
        text:           function (e) {return st.access(this, function (e) {return e === t ? st.text(this) : this.empty().append((this[0] && this[0].ownerDocument || V).createTextNode(e))}, null, e, arguments.length)}, wrapAll: function (e) {
    ...
    st.fn.extend({
        ...
        st.cssHooks[n] = {
            get: function (e, r, i) {return r ? 0 === e.offsetWidth && hn.test(st.css(e, "display")) ? st.swap(e, xn, function () {return E(e, n, i)}) : E(e, n, i) : t}, set: function (e, t, r) {
                var i = r && ln(e);
                return C(e, t, r ? k(e, n, r, st.support.boxSizing && "border-box" === st.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }), st.support.opacity || (st.cssHooks.opacity = {
        get: function (e, t) {return pn.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : t ? "1" : ""}, set: function (e, t) {
    ...
    st.fn.extend({
        serialize: function () {return st.param(this.serializeArray())}, serializeArray: function () {
    ...
    jn = Pn.exec(Dn.toLowerCase()) || [], st.fn.load = function (e, n, r) {
    ...
    }, st.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function (e, t) {st.fn[t] = function (e) {return this.on(t, e)}}), st.each(["get", "post"], function (e, n) {st[n] = function (e, r, i, o) {return st.isFunction(r) && (o = o || i, i = r, r = t), st.ajax({url: e, type: n, dataType: o, data: r, success: i})}}), st.extend({
        active:       0, lastModified: {}, etag: {}, ajaxSettings: {url: Dn, type: "GET", isLocal: Fn.test(jn[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": In, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": e.String, "text html": !0, "text json": st.parseJSON, "text xml": st.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (e, t) {return t ? H(H(e, st.ajaxSettings), t) : H(st.ajaxSettings, e)}, ajaxPrefilter: D(Wn), ajaxTransport: D($n), ajax: function (e, n) {
            ...
            return w
        }, getScript: function (e, n) {return st.get(e, t, n, "script")}, getJSON: function (e, t, n) {return st.get(e, t, n, "json")}
    ...
    st.Animation = st.extend(P, {
        ...
        }, prefilter: function (e, t) {t ? nr.unshift(e) : nr.push(e)}
    }), st.Tween = $, $.prototype = {
        constructor: $, init: function (e, t, n, r, i, o) {this.elem = e, this.prop = n, this.easing = i || "swing", this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = o || (st.cssNumber[n] ? "" : "px")}, cur: function () {
    ...
    }, $.propHooks.scrollTop = $.propHooks.scrollLeft = {set: function (e) {e.elem.nodeType && e.elem.parentNode && (e.elem[e.prop] = e.now)}}, st.each(["toggle", "show", "hide"], function (e, t) {
        var n    = st.fn[t];
        st.fn[t] = function (e, r, i) {return null == e || "boolean" == typeof e ? n.apply(this, arguments) : this.animate(I(t, !0), e, r, i)}
    }), st.fn.extend({
        fadeTo:    function (e, t, n, r) {return this.filter(w).css("opacity", 0).show().end().animate({opacity: t}, e, n, r)}, animate: function (e, t, n, r) {
...
function cargarDatosPreload() {
    if (typeof(rutaRecursos) == "undefined") rutaRecursos = "/actividades/" + $(document).data("idActividad") + "/";
    if (typeof(origenXML) == "undefined") origenXML = "/actividades/" + $(document).data("idActividad") + "/";
    var rutaXml = origenXML + "pub.xml";
    xmlDocPre   = cargarXMLDoc(rutaXml);
    if (xmlDocPre != null) {
        cargarPreload();
        setTimeout(actualizarTiempoTotal, 1000);
    }
}
var videoNo = 0;
function cargarPreload() {
    try {
        if ((xmlDocPre.getElementsByTagName("video")[0] != undefined) && (xmlDocPre.getElementsByTagName("video")[0] != null)) {
            videoPre         = xmlDocPre.getElementsByTagName("video")[0].childNodes[0].nodeValue;
            imagenPre        = xmlDocPre.getElementsByTagName("imagen")[0].childNodes[0].nodeValue;
            idPubli          = xmlDocPre.getElementsByTagName("pubid")[0].childNodes[0].nodeValue;
            modo             = xmlDocPre.getElementsByTagName("mode")[0].childNodes[0].nodeValue;
            segundosDuracion = xmlDocPre.getElementsByTagName("segs")[0].childNodes[0].nodeValue;
            try {if ((xmlDocPre.getElementsByTagName("segs_skip")[0] != undefined) && (xmlDocPre.getElementsByTagName("segs_skip")[0] != null)) segundosBoton = xmlDocPre.getElementsByTagName("segs_skip")[0].childNodes[0].nodeValue; else segundosBoton = "-";} catch (e) {}
            idioma = xmlDocPre.getElementsByTagName("idioma")[0];
            try {if ((idioma.getElementsByTagName("saltaren")[0].childNodes[0] != undefined) && (idioma.getElementsByTagName("saltaren")[0].childNodes[0] != null)) saltaren = idioma.getElementsByTagName("saltaren")[0].childNodes[0].nodeValue; else saltaren = "";} catch (e) {}
            try {if ((idioma.getElementsByTagName("segundos")[0].childNodes[0] != undefined) && (idioma.getElementsByTagName("segundos")[0].childNodes[0] != null)) txtSegundos = idioma.getElementsByTagName("segundos")[0].childNodes[0].nodeValue; else txtSegundos = "";} catch (e) {}
            try {if ((idioma.getElementsByTagName("saltar")[0].childNodes[0] != undefined) && (idioma.getElementsByTagName("saltar")[0].childNodes[0] != null)) saltar = idioma.getElementsByTagName("saltar")[0].childNodes[0].nodeValue; else saltar = "";} catch (e) {}
            try {if ((xmlDocPre.getElementsByTagName("hide_lbl")[0] != undefined) && (xmlDocPre.getElementsByTagName("hide_lbl")[0] != null)) publiSi = xmlDocPre.getElementsByTagName("hide_lbl")[0].childNodes[0].nodeValue; else publiSi = "";} catch (e) {}
            try {if ((xmlDocPre.getElementsByTagName("alt_lbl")[0] != undefined) && (xmlDocPre.getElementsByTagName("alt_lbl")[0] != null)) bannerPubli = xmlDocPre.getElementsByTagName("alt_lbl")[0].childNodes[0].nodeValue; else bannerPubli = "";} catch (e) {}
            setTimeout(function () {crearPreload();}, 100);
        }
        else {
            videoNo = 1;
            $('#enlacePubli').attr("href", "https://www.adrformacion.com");
            detener = setTimeout(function () {detenerPreload();}, 2000);
        }
    } catch (e) {
        videoNo = 1;
        $('#enlacePubli').attr("href", "https://www.adrformacion.com");
...
var ocultaBanner = 0;
function crearPreload() {
    var comprueba = videoPre.split(".educaplay.com/pub").join("");
    if ((comprueba != videoPre) && (screen.width >= 600) && (!is_touch_device())) {
        $('#preLoad').html("<div id='infoPreload'></div><div class='publi'><a href='#' id='enlacePubliVideo' target='_blank'><video id='videoPubli' autoplay onError='errorVideo()'><source  src='" + videoPre + "'></source><source src='" + videoPre.substring(0, videoPre.length - 4) + ".theora.ogv' onError='errorVideo()'></source></video></a></div>");
        if (segundosBoton != "-") {
            $('#infoPreload').html("<span id='tiempoFalta'>" + saltaren + " <span id='segFaltan'>" + segundosBoton + "</span> " + txtSegundos + " </span>");
            tiempoAct = segundosBoton;
            setTimeout(actualizarTiempoSaltar, 1000);
            $('#infoPreload').html($('#infoPreload').html() + "<a href='#' class='btn disable' id='btnSaltar'>" + saltar + "</a>");
            $('#btnSaltar').click(function (e) {e.preventDefault()});
            setTimeout(activarBoton, segundosBoton * 1000);
        }
    }
    else {videoNo = 1;}
    if (publiSi == "") {
        if (bannerPubli != "") {
            var comprueba = imagenPre.split(".educaplay.com/pub").join("");
            if (comprueba != imagenPre) {
                $('#bannerPubli').attr("src", imagenPre);
                var rutaEnlace = "/linkMgr.php?pub=" + idPubli;
                $('#enlacePubli').attr("href", rutaEnlace);
                $('#enlacePubliVideo').attr("href", rutaEnlace);
            }
        }
        else {
            $('#enlacePubli').attr("href", "https://www.adrformacion.com");
            $('#enlacePubliVideo').attr("href", "https://www.adrformacion.com");
        }
    }
    else {
        if (bannerPubli == "") {ocultaBanner = 1;}
        else {
            var comprueba = imagenPre.split(".educaplay.com/pub").join("");
            if (comprueba != imagenPre) {
                $('#bannerPubli').attr("src", imagenPre);
    ...
    detener = setTimeout(detenerPreload, segundosDuracion * 1000);
}
function errorVideo() {
    videoNo = 1;
    $('#preLoad').html("");
    setTimeout(function () {$('#preLoad').html("<img src='/img_html5/preload.gif' width='220' height='154'>");}, 500);
    setTimeout(detenerPreload, 4000);
}
function actualizarTiempoSaltar() {
    tiempoAct--;
    if (tiempoAct >= 0) {
        $('#segFaltan').text(tiempoAct);
        setTimeout(actualizarTiempoSaltar, 1000);
    }
}
function activarBoton() {
    $('#btnSaltar').removeClass('disable');
    $('#btnSaltar').click(function (e) {
        e.preventDefault();
        videoNo = 1;
        detenerPreload();
    });
...
var acabado   = 0;
var contadorF = 0;
function detenerPreload() {
    if (document.getElementById('videoPubli') != null)if (document.getElementById('videoPubli').ended) acabado = 1;
    if (videoNo == 1) acabado = 1;
    if (contadorF >= 7) acabado = 1;
    if (acabado == 1) {
    ...
    else {final = setTimeout(detenerPreload, 500);}
}
function actualizarTiempoTotal() {
    contadorF++;
    if (contadorF < 8) setTimeout(actualizarTiempoTotal, 1000);
};var origenXML        = "";
...
window.onload = function () {
    ...
    if ($(document).data("publi") == 0) {var preload = 0;}
    else {var preload = 1;}
    if ($(document).data("publiVideo") == 0) {
        setTimeout(function () {
            $('#preLoad').hide();
            $('#contentPreActividad').show();
            cargarDescripcionInicio();
    ...
    var preloadEducaplay       = 0;
    var tiempoPreloadEducaplay = 0;
    var marcaEducaplayD        = 0;
    if ((navigator.userAgent.match(/android 1/i)) || (navigator.userAgent.match(/android 2/i))) {$("body").addClass("android");}
    rutaRecursos       = "/actividades/" + $(document).data("idActividad") + "/";
    rutaRecursosDownl  = "";
    rutaRecursosInicio = rutaRecursos;
    if ($(document).data("publi") == 0) {cargarXMLDoc(rutaRecursos + "pub.xml");}
    if ($(document).data("idActividad") == "1150189") preload = 0;
    ...
    try {
        ...
        if (dentro) {
            ...
            var cad2 = /groups/;
            var cad3 = /groupes/;
            if ((cad1.test(parLoc)) || (cad2.test(parLoc)) || (cad3.test(parLoc))) {dentro = false;} else {dentro = true;}
        }
    }
    catch (e) {var dentro = false;}
    if (window == window.top) {
        ...
        if ($(".groupColeccion").length) {
            ...
            $('.btnToggleColeccion2').click(function (e) {
                e.preventDefault();
                if ($('.capsulaActividad').css('top') == '27px') {
                    $('.capsulaActividad').animate({top: '152px'}, 1200);
                    $(this).addClass("active");
                }
                else {
                    $('.capsulaActividad').animate({top: '27px'}, 1200);
                    $(this).removeClass("active");
                }
                $('.contentToggleBar').slideToggle(1200, "swing", function () {});
            });
            $(".btnNav2").bind("click", function (e) {
                e.preventDefault();
                if ($(".carruselenlace" + $(this).data('enl')).length) {window.location.href = $(".carruselenlace" + $(this).data('enl')).attr("href");}
            });
        }
    }
    else if (!dentro) {
    ...
    if (preload == 1) {
        $('#bannerPubli').show();
        $('#banner').show();
        if ($(document).data("esVideoquiz") == 1) {
            detener = setTimeout(function () {
                clearTimeout(detener);
                clearTimeout(final);
                $('#preLoad').hide();
                $('#contentPreActividad').show();
        ...
        if (preloadEducaplay == 1) {
            $('#preLoad').html("<img src='img_html5/preload.gif' width='220' height='154'>");
            setTimeout(function () {
                $('#preLoad').hide();
                $('#contentPreActividad').show();
                cargarDescripcionInicio();
            }, tiempoPreloadEducaplay * 1000);
        }
        else {
            $('#preLoad').hide();
            $('#contentPreActividad').show();
...
function cargarXMLDoc(archivoXML) {
    ...
    try {
        if (document.all) {xmlDoc = new ActiveXObject("Microsoft.XMLDOM");}
...
function cargarXMLJS() {return jQuery.parseXML(DatosActividad);};function inicializarColores() {
    var dif    = 26;
...
function inicializarPantallaInicial() {
    ...
    $('#btnComenzarInicio a').click(function (e) {
        e.preventDefault();
        entrarPantallaCompleta();
        comenzar();
        $('.logoPersonalizado').hide();
        $('.franjaPersonalizada').hide();
    });
    if (autor != '') {
    ...
    setTimeout(function () {if (ocultaBanner == 1) $("#banner").hide();}, 3000);
    if (logoPersonalizado != "no" && logoPersonalizado != "") {
        if (franjaPersonalizada != "no" && franjaPersonalizada != "") {$('.logoPersonalizado').addClass('lpf');}
...
function inicializarOrtografia() {
    ...
    if (sensible_mayusculas_ocultar == "si") {$('#inicioMay').hide();}
    if (sensible_acentos_ocultar == "si") {$('#inicioAce').hide();}
}
function inicializarContadorTiempo() {
    if (tiempo == 0) {
        ...
        if (horas == "") $("#numTiempo").html(minutos + ":" + segundos); else $("#numTiempo").html(horas + ":" + minutos + ":" + segundos);
        if (horas == "") tiempoReg = minutos + ":" + segundos; else tiempoReg = horas + ":" + minutos + ":" + segundos;
        $("#inicioTitTiempo").text(txtTiempoMaximo);
        if (horas == "") $("#inicioTiempo").html(minutos + ":" + segundos); else $("#inicioTiempo").html(horas + ":" + minutos + ":" + segundos);
    }
}
function inicializarTituloAct() {
    var esGAM = false;
    try {if (xmlDoc.getElementsByTagName("gam")[0].childNodes[0].nodeValue == 'si') {esGAM = true;}} catch (e) {}
    if ((window == window.top) && (!esGAM)) {$('#enlaceTitAct').html(enunciado);}
    else {$('#tituloAct').html(enunciado);}
}
function inicializarAlertaCorrecta() {
    $('#textoCorrecto').text(txtBoxRespuestaCorrecta);
    $('#tituloCorrecto').text(enunciado);
}
function inicializarAlertaIncorrecta() {$('#tituloMAL').text(enunciado);}
...
function inicializarZoom() {
    ...
    $("#zoomUp").click(function (e) {
        e.preventDefault();
        redimensionar("up");
    });
    $("#encajarEnPantalla").click(function (e) {
        e.preventDefault();
        redimensionar("encaja");
    });
    $("#zoomDown").click(function (e) {
        e.preventDefault();
        redimensionar("down");
    });
    $("#infoZoom").hide();
    ...
    try {
        ...
        var dirA     = dir.split('idGrupo=');
        var idGrupoA = dirA[1].split('&');
        var idGrupo  = idGrupoA[0];
    }
    catch (e) {var idGrupo = "";}
    $("a[class*='carruselenlace']").each(function () {
        var url  = $(this).attr('href');
        var urlA = url.replace("#!", "");
        var urlN = urlA + "&idGrupo=" + idGrupo;
        urlN     = urlN.replace("#!", "");
        urlN     = urlN + "#!";
        $(this).attr('href', urlN);
    });
...
function preg_replace(pattern, replacement, subject, limit) {
    ...
    if (subject.match(eval(pattern))) {
        if (limit == -1) {return subject.replace(eval(pattern + "g"), replacement);}
        else {
            for (x = 0; x < limit; x++) {subject = subject.replace(eval(pattern), replacement);}
            return subject;
        }
    } else {return subject;}
}
function libLinkCreator(string, params) {
    ...
    if (params.linkReplace) {replaceLinkText = params.linkReplace;}
    if (string == '') {return;}
...
function is_touch_device() {
    ...
    if ((navigator.userAgent.toLowerCase().indexOf('safari/') != -1) && (navigator.appVersion.indexOf("Win") != -1) && (navigator.userAgent.toLowerCase().indexOf('chrome/') == -1)) {return true;}
    else {return false;}
}
var tiempoReg = "00:00";
function contador() {
    ...
    if (actual.length > 5) {
        ...
        if ((horas == 0) && (minutos == 0) && (segundos == 10) && (tiempo != 0)) {$('#cajaTiempo').addClass('alertLuz');}
        if ((horas == 0) && (minutos == 0) && (segundos == 0)) {
            ...
            else cargarPantallaFinal('tiempo');
        }
    }
    else {
        ...
        if (minutos == 60) {
            ...
            if ((minutos == 0) && (segundos == 10) && (tiempo != 0)) {$('#cajaTiempo').addClass('alertLuz');}
...
function cargarPantallaFinal(tipoAlerta) {
    ...
    if ((numero_intentos == 0) || (numero_intentos == "noDefinido")) {
        if (tipoAlerta == "tiempo") {
            if ((tipo_actividad != "Sopa") && (tipo_actividad != "Dictado") && (tipo_actividad != "Mapa") && (tipo_actividad != "Crucigrama")) {
                $("#valorPuntos").html(0);
                puntosReg = 0;
            }
            else {$("#valorPuntos").html(puntosReg);}
        }
        else {$("#valorPuntos").html(puntosReg);}
        if (tiempo == 0) {$("#valorTiempo").html(tiempoReg);}
        else {
        ...
        if ((tipoAlerta == "tiempo") || (tipoAlerta == "intentos")) {
            if (tipo_actividad == "Completar") {
                if (tipoAlerta == "tiempo") compruebaTexto("finTiempo"); else compruebaTexto("finIntentos");
        ...
        else {$("#valorPuntosI").html(puntosReg);}
        if (tiempo == 0) {$("#valorTiempoI").html(tiempoReg);}
        else {
            var posicionTiempo      = 0;
            var tiempoFinalRestante = tiempoReg;
            for (i = 0; i < tiempoFinalRestante.length; i++) {
        ...
        var intento   = 0;
        if (tipoAlerta == 'OK') {if (typeof(ACT_SUMARINTENTOSFINAL) == 'undefined') {intento = 1;} else {intento = ACT_SUMARINTENTOSFINAL;}}
...
function loaded() {myScroll = setTimeout(function () {new iScroll('wrapper', {zoom: true})}, 12000);}
function handle(delta) {if (delta < 0) redimensionar('down'); else redimensionar('up');}
...
function inicializarRegistro() {if (registro.getElementsByTagName("tipo")[0].childNodes[0].nodeValue == "scorm") {inicializarRegistroScorm();}}
function inicializarRegistroScorm() {
    ...
    } catch (error) {inicializadoScorm = false;}
    return;
}
function setRegistroPuntuacion(n) {registroPuntuacion = n;}
function setRegistroTiempo(t) {registroTiempo = t;}
function finalizar() {
    if (registro.getElementsByTagName("tipo")[0].childNodes[0].nodeValue == "scorm") {_finalizarSCORM();} else if (registro.getElementsByTagName("tipo")[0].childNodes[0].nodeValue == "script") {_finalizarScript();}
    try {parent.finActividad();} catch (error) {}
}
...
function _finalizarSCORM() {
    ...
    if (!registroRealizado) {
        if (inicializadoScorm) {
            ...
            if (!estado) {
                if (finalizado) {
                    if (finOK == 1) {adrSetValue("estado", "finalizadoOK");}
                    else {adrSetValue("estado", "finalizadoERROR");}
                } else {adrSetValue("estado", "noFinalizado");}
                adrSetValue("resultado", _getValor('SCORE'));
            }
            commitScorm     = adrCommit();
            finalizadoScorm = adrFinalizar();
            if ((commitScorm) && (finalizadoScorm)) {registroRealizado = true;}
        }
    }
}
function _finalizarScript() {
    var i         = 0;
    var variables = {};
    parametrosReg = registro.getElementsByTagName("parametros")[0];
    var aux       = "";
    if (registroRealizado) {return;}
    for (i = 0; i < parametrosReg.getElementsByTagName("parametro").length; i++) {variables[parametrosReg.getElementsByTagName("parametro")[i].getElementsByTagName("nombre")[0].childNodes[0].nodeValue] = _getValor(parametrosReg.getElementsByTagName("parametro")[i].getElementsByTagName("valor")[0].childNodes[0].nodeValue);}
    registroURL = registro.getElementsByTagName("url")[0].childNodes[0].nodeValue;
    if ($("#idColeccion").length) {registroURL += '&idColeccion=' + $("#idColeccion").html();}
    var codigo = "score=" + variables["score"] + "&time=" + variables["time"];
    codigoM    = calcMD5(codigo);
    if (stmt != 0) {
        variables['finalizacion'] = stmt;
        variables['respuestas']   = respuestasXAPI;
    }
    $.ajaxSetup({
        beforeSend: function (xhr) {xhr.setRequestHeader("eduToken", codigoM);}
    });
    if ($(document).data("environment") != '') {
    ...
    $.ajax({
        type: "POST", url: registroURL, data: variables, cache: false, success: function () {
...
function add(x, y) {return ((x & 0x7FFFFFFF) + (y & 0x7FFFFFFF)) ^ (x & 0x120000000) ^ (y & 0x120000000);}
...
function calcMD5(sInp) {
    ...
    for (i = 0; (i * 4) < sInp.length; i++) {
        X[i] = 0;
        for (j = 0; (j < 4) && ((j + i * 4) < sInp.length); j++) {X[i] += (sAscii.indexOf(sInp.charAt((i * 4) + j)) + 32) << (j * 8);}
    }
    if (j == 4) {X[i++] = 0x80;}
    else {X[i - 1] += 0x80 << (j * 8);}
    for (; i < wLen; i++) {X[i] = 0;}
...
function entrarPantallaCompleta() {try {if (parent.innerWidth < 1200) {launchFullScreen(document.documentElement);}} catch (err) {}}
function salirPantallaCompleta() {cancelFullScreen();}
function launchFullScreen(element) {try {if (element.requestFullScreen) {element.requestFullScreen();} else if (element.mozRequestFullScreen) {element.mozRequestFullScreen();} else if (element.webkitRequestFullScreen) {element.webkitRequestFullScreen();} else if (element.msRequestFullscreen) {element.msRequestFullscreen();} else {parent.maximizar();}} catch (err) {}}
function cancelFullScreen() {try {if (document.cancelFullScreen) {document.cancelFullScreen();} else if (document.mozCancelFullScreen) {document.mozCancelFullScreen();} else if (document.webkitCancelFullScreen) {document.webkitCancelFullScreen();} else if (document.msExitFullscreen) {document.msExitFullscreen();} else {parent.minimizar();}} catch (err) {}};(function ($) {
    $.fn.extend({
        jsCarousel: function (options) {
            var settings = $.extend({scrollspeed: 1500, delay: 5000, itemstodisplay: 5, autoscroll: false, circular: false, masked: true, onthumbnailclick: null, orientation: 'h'}, options);
            return this.each(function () {
                ...
                function initialize() {
                    ...
                    for (var i = 0; i < noOfBlocks; i++) {
                        ...
                        allElements.slice(startIndex, endIndex).each(function (index, el) {
                            if (!copy)
                                wrapper.append(el); else wrapper.append($(el).clone(true));
                        });
                        wrapper.find("img").click(function () {if (settings.onthumbnailclick != null) {settings.onthumbnailclick($(this).attr('src'));}});
                ...
                function changeSlide() {
                    if (direction == "forward") {if (index <= 0) index = noOfBlocks;} else {if (index >= noOfBlocks - 1) {index = -1;}}
                    showThumbs();
                    interval = setTimeout(changeSlide, settings.delay);
                }
                ...
                function showThumbs() {
                    ...
                    if (direction == "forward") {
                        ...
                        if (index < noOfBlocks) {
                            if (settings.orientation == 'v') {
                                $('>div:eq(' + index + ')', slidercontents).removeClass('hidden').addClass('visible').css({'top': getDimensions(-containerHeight)}).stop(false, true).animate({'top': top}, scrollSpeed, function () {scrolling = false;});
                                current.stop(false, true).animate({'top': '+=' + getDimensions(containerHeight)}, scrollSpeed, function () {
                                    $(this).removeClass('visible').addClass('hidden');
                                ...
                                $('>div:eq(' + index + ')', slidercontents).removeClass('hidden').addClass('visible').css({'left': getDimensions(-containerWidth)}).stop(false, true).animate({'left': '+=' + getDimensions(containerWidth)}, scrollSpeed, function () {scrolling = false;});
                                current.stop(false, true).animate({'left': '+=' + getDimensions(containerWidth)}, scrollSpeed, function () {
                                    $(this).removeClass('visible').addClass('hidden');
...
;function asignaColor() {
    if ((colorFondo != "inicio") && (colorBotonesC != "inicio") && (colorBotonesO != "inicio") && (colorFondoC != "inicio") && (colorFondoO != "inicio") && (colorFuente != "inicio") && (colorFuenteB != "inicio")) {
        ...
        if (colorFuente != '#FFFFFF') {
            cadenaColor += ".iSensible, .accordionButton, .optionsAct a {background-image: url(" + obtenerRutaImg() + "iconsBlack.png);}";
    ...
    else {setTimeout(function () {asignaColor();}, 200);}
}
colorFuenteB  = "inicio";
colorFuente   = "inicio";
colorFondo    = "inicio";
...
asignaColor();
function obtenerRutaImg() {
    var v_ruta = $('#iconoACT').attr('src').split('/');
    var ruta   = '';
    for (i = 0; i < v_ruta.length - 1; i++) {ruta += v_ruta[i] + '/';}
    return ruta;
}